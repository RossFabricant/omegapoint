...
class ExperimentType(sgqlc.types.Enum):
    __schema__ = schema
    __choices__ = ("SIMULATION", "PORTFOLIO", "OPTIMIZATION", "INSIGHT")
...
class PositionSetType(sgqlc.types.Enum):
    __schema__ = schema
    __choices__ = ("PORTFOLIO", "BENCHMARK", "SWAP")
...
class CustomOptimizationObjective(sgqlc.types.Input):
    __schema__ = schema
    minimize_risk = sgqlc.types.Field(
        "CustomRiskObjectiveTerm", graphql_name="minimizeRisk"
    )
    maximize_forecast_return = sgqlc.types.Field(
        CustomObjectiveTermWeight, graphql_name="maximizeForecastReturn"
    )
    minimize_market_impact = sgqlc.types.Field(
        CustomObjectiveTermWeight, graphql_name="minimizeMarketImpact"
    )


class CustomRiskObjectiveTerm(sgqlc.types.Input):
    __schema__ = schema
    factor_risk = sgqlc.types.Field(
        CustomObjectiveTermWeight, graphql_name="factorRisk"
    )
    specific_risk = sgqlc.types.Field(
        CustomObjectiveTermWeight, graphql_name="specificRisk"
    )
...
class ForecastEquityInput(sgqlc.types.Input):
    ...
    expected_percent_return = sgqlc.types.Field(
        Float, graphql_name="expectedPercentReturn"
    )
...
class ForecastInput(sgqlc.types.Input):
    ...
    implied_returns = sgqlc.types.Field(
        ImpliedReturnsType, graphql_name="impliedReturns"
    )
    horizon = sgqlc.types.Field(Int, graphql_name="horizon")
    equities = sgqlc.types.Field(
        sgqlc.types.list_of(ForecastEquityInput), graphql_name="equities"
    )
    swaps = sgqlc.types.Field(
        sgqlc.types.list_of("ForecastSwapInput"), graphql_name="swaps"
    )
...
class ForecastSecurityInput(sgqlc.types.Input):
    ...
    expected_return = sgqlc.types.Field(
        sgqlc.types.non_null(ForecastExpectedReturnInput), graphql_name="expectedReturn"
    )
...
class NewPortfolio(sgqlc.types.Input):
    ...
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name="name")
    description = sgqlc.types.Field(String, graphql_name="description")
    default_model_id = sgqlc.types.Field(
        sgqlc.types.non_null(String), graphql_name="defaultModelId"
    )
    rollover_position_set_to_current_date = sgqlc.types.Field(
        Boolean, graphql_name="rolloverPositionSetToCurrentDate"
    )
...
class OptimizationCompositionConstraint(sgqlc.types.Input):
    ...
    type = sgqlc.types.Field(
        sgqlc.types.non_null(CompositionConstraintType), graphql_name="type"
    )
    max_economic_exposure = sgqlc.types.Field(
        sgqlc.types.non_null(Float), graphql_name="maxEconomicExposure"
    )
    min_economic_exposure = sgqlc.types.Field(
        sgqlc.types.non_null(Float), graphql_name="minEconomicExposure"
    )
...
class OptimizationConstraints(sgqlc.types.Input):
    ...
    exposure = sgqlc.types.Field(
        sgqlc.types.list_of(ExposureConstraint), graphql_name="exposure"
    )
    securities = sgqlc.types.Field("SecurityConstraintInput", graphql_name="securities")
    composition = sgqlc.types.Field(
        sgqlc.types.list_of(OptimizationCompositionConstraint),
        graphql_name="composition",
    )
    min_trade = sgqlc.types.Field(Float, graphql_name="minTrade")
    max_trade = sgqlc.types.Field(
        "OptimizationMaxTradeConstraint", graphql_name="maxTrade"
    )
    ...
    min_short_market_value = sgqlc.types.Field(
        Float, graphql_name="minShortMarketValue"
    )
    max_short_market_value = sgqlc.types.Field(
        Float, graphql_name="maxShortMarketValue"
    )
    ...
    security_min_trade = sgqlc.types.Field(
        "SecurityMinTradeInput", graphql_name="securityMinTrade"
    )
    fix_position_set_securities = sgqlc.types.Field(
        Boolean, graphql_name="fixPositionSetSecurities"
    )
    trade_swaps = sgqlc.types.Field(Boolean, graphql_name="tradeSwaps")
    max_market_impact_cost = sgqlc.types.Field(
        Float, graphql_name="maxMarketImpactCost"
    )
...
class OptimizationMaxTradeConstraint(sgqlc.types.Input):
    ...
    percent_original_economic_exposure = sgqlc.types.Field(
        Float, graphql_name="percentOriginalEconomicExposure"
    )
...
class OptimizationObjective(sgqlc.types.Input):
    ...
    target_exposures = sgqlc.types.Field(
        sgqlc.types.list_of("TargetExposure"), graphql_name="targetExposures"
    )
    ...
    factor_exposure = sgqlc.types.Field(
        FactorExposureTarget, graphql_name="factorExposure"
    )
...
class OptimizationObjectiveOptionsInput(sgqlc.types.Input):
    __schema__ = schema
    include_market_impact = sgqlc.types.Field(
        Boolean, graphql_name="includeMarketImpact"
    )
...
class OptimizationOptionsInput(sgqlc.types.Input):
    ...
    objectives = sgqlc.types.Field(
        OptimizationObjectiveOptionsInput, graphql_name="objectives"
    )
    equity = sgqlc.types.Field(Float, graphql_name="equity")
...
class OptimizationSecuritySearchInput(sgqlc.types.Input):
    __schema__ = schema
    filter = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null("SecuritySearchFilter"))
        ),
        graphql_name="filter",
    )
    sort = sgqlc.types.Field(
        sgqlc.types.list_of("SecuritySearchSort"), graphql_name="sort"
    )
...
class PnlDateInput(sgqlc.types.Input):
    ...
    equities = sgqlc.types.Field(
        sgqlc.types.list_of("PnlEquityInput"), graphql_name="equities"
    )
    currencies = sgqlc.types.Field(
        sgqlc.types.list_of("PnlOtherAssetInput"), graphql_name="currencies"
    )
    swaps = sgqlc.types.Field(
        sgqlc.types.list_of("PnlOtherAssetInput"), graphql_name="swaps"
    )
    fixed_income = sgqlc.types.Field(
        sgqlc.types.list_of("PnlFixedIncomeInput"), graphql_name="fixedIncome"
    )
    commodities = sgqlc.types.Field(
        sgqlc.types.list_of("PnlOtherAssetInput"), graphql_name="commodities"
    )
    indices = sgqlc.types.Field(
        sgqlc.types.list_of("PnlOtherAssetInput"), graphql_name="indices"
    )
    other_assets = sgqlc.types.Field(
        sgqlc.types.list_of("PnlOtherAssetInput"), graphql_name="otherAssets"
    )
...
class PnlEquityInput(sgqlc.types.Input):
    ...
    id = sgqlc.types.Field(
        sgqlc.types.non_null("PositionSetEquityIdInput"), graphql_name="id"
    )
...
class PnlFixedIncomeInput(sgqlc.types.Input):
    __schema__ = schema
    id = sgqlc.types.Field(
        sgqlc.types.non_null("PositionSetFixedIncomeIdInput"), graphql_name="id"
    )
    amount = sgqlc.types.Field(sgqlc.types.non_null(Float), graphql_name="amount")
...
class PositionSetDateInput(sgqlc.types.Input):
    ...
    equity = sgqlc.types.Field(Float, graphql_name="equity")
    equities = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetEquityInput"), graphql_name="equities"
    )
    currencies = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetOtherAssetInput"), graphql_name="currencies"
    )
    swaps = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetOtherAssetInput"), graphql_name="swaps"
    )
    fixed_income = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetFixedIncomeInput"), graphql_name="fixedIncome"
    )
    commodities = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetOtherAssetInput"), graphql_name="commodities"
    )
    indices = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetOtherAssetInput"), graphql_name="indices"
    )
    other_assets = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetOtherAssetInput"), graphql_name="otherAssets"
    )
...
class PositionSetEquityInput(sgqlc.types.Input):
    ...
    economic_exposure = sgqlc.types.Field(
        sgqlc.types.non_null(Float), graphql_name="economicExposure"
    )
...
class PositionSetInput(sgqlc.types.Input):
    ...
    weight = sgqlc.types.Field(Float, graphql_name="weight")
    dates = sgqlc.types.Field(
        sgqlc.types.list_of(PositionSetDateInput), graphql_name="dates"
    )
...
class SecuritiesInput(sgqlc.types.Input):
    ...
    security_search = sgqlc.types.Field(
        OptimizationSecuritySearchInput, graphql_name="securitySearch"
    )
    equities = sgqlc.types.Field(
        sgqlc.types.list_of(SecuritiesEquityInput), graphql_name="equities"
    )
    swaps = sgqlc.types.Field(
        sgqlc.types.list_of("SecuritiesSwapInput"), graphql_name="swaps"
    )
...
class SecurityConstraintInput(sgqlc.types.Input):
    __schema__ = schema
    equities = sgqlc.types.Field(
        sgqlc.types.list_of("SecurityConstraintInputEquity"), graphql_name="equities"
    )
    swaps = sgqlc.types.Field(
        sgqlc.types.list_of("SecurityConstraintInputSwap"), graphql_name="swaps"
    )
...
class SecurityMinTradeInput(sgqlc.types.Input):
    __schema__ = schema
    equities = sgqlc.types.Field(
        sgqlc.types.list_of("SecurityMinTradeInputEquity"), graphql_name="equities"
    )
...
class SecuritySearchFilter(sgqlc.types.Input):
    __schema__ = schema
    factor_exposure = sgqlc.types.Field(
        sgqlc.types.list_of("SecuritySearchFilterFactorExposure"),
        graphql_name="factorExposure",
    )
    ...
    asset_class = sgqlc.types.Field(
        "SecuritySearchFilterString", graphql_name="assetClass"
    )
    asset_subclass = sgqlc.types.Field(
        "SecuritySearchFilterString", graphql_name="assetSubclass"
    )
    average_daily_volume = sgqlc.types.Field(
        "SecuritySearchFilterFloat", graphql_name="averageDailyVolume"
    )
    market_capitalization = sgqlc.types.Field(
        "SecuritySearchFilterFloat", graphql_name="marketCapitalization"
    )
    universe = sgqlc.types.Field(
        sgqlc.types.list_of("SecuritySearchFilterUniverse"), graphql_name="universe"
    )
    securities = sgqlc.types.Field(
        "SecuritySearchFilterSecurities", graphql_name="securities"
    )
    risk = sgqlc.types.Field(
        sgqlc.types.list_of("SecuritySearchFilterRisk"), graphql_name="risk"
    )
...
class SecuritySearchFilterSecurities(sgqlc.types.Input):
    ...
    not_in = sgqlc.types.Field(
        sgqlc.types.list_of("UniversalIdInput"), graphql_name="notIn"
    )
...
class SecuritySearchSort(sgqlc.types.Input):
    ...
    direction = sgqlc.types.Field(
        sgqlc.types.non_null(SortDirection), graphql_name="direction"
    )
...
class WatchlistSecuritiesInput(sgqlc.types.Input):
    __schema__ = schema
    equities = sgqlc.types.Field(
        sgqlc.types.list_of(PositionSetEquityIdInput), graphql_name="equities"
    )
    currencies = sgqlc.types.Field(
        sgqlc.types.list_of(String), graphql_name="currencies"
    )
    swaps = sgqlc.types.Field(sgqlc.types.list_of(String), graphql_name="swaps")
    fixed_income = sgqlc.types.Field(
        sgqlc.types.list_of(PositionSetFixedIncomeIdInput), graphql_name="fixedIncome"
    )
    commodities = sgqlc.types.Field(
        sgqlc.types.list_of(String), graphql_name="commodities"
    )
...
class Category(sgqlc.types.Type):
    ...
    factors = sgqlc.types.Field(
        sgqlc.types.list_of("CategoryFactor"), graphql_name="factors"
    )
...
class Composition(sgqlc.types.Type):
    ...
    summary_stats = sgqlc.types.Field(
        "CompositionSummaryStats", graphql_name="summaryStats"
    )
    concentration = sgqlc.types.Field(
        "CompositionConcentration", graphql_name="concentration"
    )
    composition_by = sgqlc.types.Field(
        sgqlc.types.list_of("CompositionGroup"),
        graphql_name="compositionBy",
        args=sgqlc.types.ArgDict(
            (
                (
                    "group_by",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(ContributorGroupType),
    ...
    positions = sgqlc.types.Field(
        sgqlc.types.list_of("CompositionPositions"), graphql_name="positions"
    )
...
class CompositionPositions(sgqlc.types.Type):
    ...
    industry_classification = sgqlc.types.Field(
        "SecurityDescriptor",
        graphql_name="industryClassification",
        args=sgqlc.types.ArgDict(
            (
                (
                    "type",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(IndustryClassificationType),
                        graphql_name="type",
                        default=None,
                    ),
                ),
...
class CompositionSummaryStats(sgqlc.types.Type):
    __schema__ = schema
    average = sgqlc.types.Field(
        "CompositionSummaryStatsAverage", graphql_name="average"
    )
...
class CompositionSummaryStatsAverage(sgqlc.types.Type):
    __schema__ = schema
    market_capitalization = sgqlc.types.Field(
        Float, graphql_name="marketCapitalization"
    )
...
class ContentSet(sgqlc.types.Type):
    ...
    id = sgqlc.types.Field(String, graphql_name="id")
    name = sgqlc.types.Field(String, graphql_name="name")
    availability = sgqlc.types.Field(
        "ContentSetAvailability", graphql_name="availability"
    )
    factors = sgqlc.types.Field(
        sgqlc.types.list_of("ContentSetFactor"),
        ...
        args=sgqlc.types.ArgDict(
            (
                ...
                (
                    "id",
                    sgqlc.types.Arg(
                        sgqlc.types.list_of(String), graphql_name="id", default=None
                    ),
                ),
            )
        ),
...
class ContentSetMetadata(sgqlc.types.Type):
    ...
    name = sgqlc.types.Field(String, graphql_name="name")
    factors = sgqlc.types.Field(
        sgqlc.types.list_of(ContentSetFactor), graphql_name="factors"
    )
    categories = sgqlc.types.Field(
        sgqlc.types.list_of(Category), graphql_name="categories"
    )
...
class Coverage(sgqlc.types.Type):
    ...
    missing_equities = sgqlc.types.Field(
        sgqlc.types.list_of("MissingEquity"), graphql_name="missingEquities"
    )
    missing_currencies = sgqlc.types.Field(
        sgqlc.types.list_of("MissingOtherAsset"), graphql_name="missingCurrencies"
    )
    missing_swaps = sgqlc.types.Field(
        sgqlc.types.list_of("MissingOtherAsset"), graphql_name="missingSwaps"
    )
    missing_commodities = sgqlc.types.Field(
        sgqlc.types.list_of("MissingOtherAsset"), graphql_name="missingCommodities"
    )
    missing_indices = sgqlc.types.Field(
        sgqlc.types.list_of("MissingOtherAsset"), graphql_name="missingIndices"
    )
    missing_fixed_income = sgqlc.types.Field(
        sgqlc.types.list_of("MissingFixedIncome"), graphql_name="missingFixedIncome"
    )
    missing_other_assets = sgqlc.types.Field(
        sgqlc.types.list_of("MissingOtherAsset"), graphql_name="missingOtherAssets"
    )
...
class CoverageSummary(sgqlc.types.Type):
    ...
    percent_gmv_not_available = sgqlc.types.Field(
        Float, graphql_name="percentGmvNotAvailable"
    )
...
class Experiment(sgqlc.types.Type):
    ...
    dates = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetDate"),
        graphql_name="dates",
        args=sgqlc.types.ArgDict(
            (
                (
                    "from_",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(Date), graphql_name="from", default=None
                    ),
                ),
                (
                    "to",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(Date), graphql_name="to", default=None
                    ),
                ),
                (
                    "interval",
                    sgqlc.types.Arg(
                        PositionSetInterval, graphql_name="interval", default=None
                    ),
                ),
            )
        ),
...
class Exposure(sgqlc.types.Type):
    ...
    factors = sgqlc.types.Field(
        sgqlc.types.list_of("ExposureFactor"),
        graphql_name="factors",
        args=sgqlc.types.ArgDict(
            (
                (
...
class ExposureContributor(sgqlc.types.Type):
    ...
    cusip = sgqlc.types.Field(Cusip, graphql_name="cusip")
    factors = sgqlc.types.Field(
        sgqlc.types.list_of("ExposureContributorFactor"),
        graphql_name="factors",
        args=sgqlc.types.ArgDict(
            (
                (
...
class ExposureContributorDate(sgqlc.types.Type):
    ...
    date = sgqlc.types.Field(Date, graphql_name="date")
    rolled_over_from = sgqlc.types.Field(Date, graphql_name="rolledOverFrom")
    contributors = sgqlc.types.Field(
        sgqlc.types.list_of(ExposureContributor), graphql_name="contributors"
    )
...
class ExposureContributorGroup(sgqlc.types.Type):
    ...
    factors = sgqlc.types.Field(
        sgqlc.types.list_of("ExposureContributorGroupFactor"),
        graphql_name="factors",
        args=sgqlc.types.ArgDict(
            (
                (
...
class Factor(sgqlc.types.Type):
    ...
    name = sgqlc.types.Field(String, graphql_name="name")
    category = sgqlc.types.Field(String, graphql_name="category")
    performance = sgqlc.types.Field(
        sgqlc.types.list_of("FactorPerformance"),
        graphql_name="performance",
        args=sgqlc.types.ArgDict(
            (
                (
                    "from_",
                ...
                (
                    "aggregation",
                    sgqlc.types.Arg(
                        Aggregation, graphql_name="aggregation", default=None
                    ),
                ),
                (
                    "interval",
                    sgqlc.types.Arg(Interval, graphql_name="interval", default=None),
                ),
            )
        ),
    )
    covariance = sgqlc.types.Field(
        "FactorCovariance",
        graphql_name="covariance",
        args=sgqlc.types.ArgDict(
            (
                (
                    "on",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(Date), graphql_name="on", default=None
                    ),
                ),
            )
        ),
...
class FactorCovariance(sgqlc.types.Type):
    ...
    date = sgqlc.types.Field(Date, graphql_name="date")
    factors = sgqlc.types.Field(
        sgqlc.types.list_of("FactorCovarianceValue"),
        graphql_name="factors",
        args=sgqlc.types.ArgDict(
            (
                (
...
class FactorCovarianceValue(sgqlc.types.Type):
    ...
    name = sgqlc.types.Field(String, graphql_name="name")
    category = sgqlc.types.Field(String, graphql_name="category")
    annualized_percent_squared = sgqlc.types.Field(
        Float, graphql_name="annualizedPercentSquared"
    )
...
class FactorPerformance(sgqlc.types.Type):
    __schema__ = schema
    date = sgqlc.types.Field(Date, graphql_name="date")
    percent_price_change1_day = sgqlc.types.Field(
        Float, graphql_name="percentPriceChange1Day"
    )
    percent_price_change_cumulative = sgqlc.types.Field(
        Float, graphql_name="percentPriceChangeCumulative"
    )
...
class Forecast(sgqlc.types.Type):
    ...
    equities = sgqlc.types.Field(
        sgqlc.types.list_of("ForecastEquity"), graphql_name="equities"
    )
...
class ForecastDetails(sgqlc.types.Type):
    ...
    dates = sgqlc.types.Field(
        sgqlc.types.list_of("ForecastDetailsDate"),
        graphql_name="dates",
        args=sgqlc.types.ArgDict(
            (
                (
    ...
    security_dates = sgqlc.types.Field(
        sgqlc.types.list_of("ForecastSecurity"),
        graphql_name="securityDates",
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(UniversalIdInput),
                        graphql_name="id",
                        default=None,
                    ),
                ),
...
class ForecastDetailsDate(sgqlc.types.Type):
    ...
    as_of = sgqlc.types.Field(Date, graphql_name="asOf")
    securities = sgqlc.types.Field(
        sgqlc.types.list_of("ForecastSecurity"), graphql_name="securities"
    )
...
class ForecastSecurity(sgqlc.types.Type):
    ...
    as_of = sgqlc.types.Field(Date, graphql_name="asOf")
    expected_return = sgqlc.types.Field(
        ForecastExpectedReturn, graphql_name="expectedReturn"
    )
...
class ForecastTypes(sgqlc.types.Type):
    ...
    implied_returns = sgqlc.types.Field(
        Forecast,
        graphql_name="impliedReturns",
        args=sgqlc.types.ArgDict(
            (
                (
                    "risk_factors",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(ImpliedReturnsType),
        ...
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(ShortId), graphql_name="id", default=None
                    ),
                ),
            )
        ),
...
class ForecastUpdateResult(sgqlc.types.Type):
    ...
    unmapped_securities = sgqlc.types.Field(
        sgqlc.types.list_of(ForecastSecurity), graphql_name="unmappedSecurities"
    )
...
class GroupedExposureContributorDate(sgqlc.types.Type):
    ...
    date = sgqlc.types.Field(Date, graphql_name="date")
    rolled_over_from = sgqlc.types.Field(Date, graphql_name="rolledOverFrom")
    grouped_contributors = sgqlc.types.Field(
        sgqlc.types.list_of(ExposureContributorGroup),
        graphql_name="groupedContributors",
    )
...
class MarketImpact(sgqlc.types.Type):
    ...
    contributors = sgqlc.types.Field(
        sgqlc.types.list_of("MarketImpactContributor"), graphql_name="contributors"
    )
...
class Model(sgqlc.types.Type):
    ...
    benchmarks = sgqlc.types.Field(
        sgqlc.types.list_of(BenchmarkMetadata), graphql_name="benchmarks"
    )
    factors = sgqlc.types.Field(
        sgqlc.types.list_of(Factor),
        graphql_name="factors",
        args=sgqlc.types.ArgDict(
            (
                (
    ...
    security = sgqlc.types.Field(
        "Security",
        graphql_name="security",
        args=sgqlc.types.ArgDict(
            (
                (
                    "ticker",
                    sgqlc.types.Arg(String, graphql_name="ticker", default=None),
                ),
                (
                    "exchange",
                    sgqlc.types.Arg(String, graphql_name="exchange", default=None),
                ),
                ...
                (
                    "model_provider_id",
                    sgqlc.types.Arg(
                        String, graphql_name="modelProviderId", default=None
                    ),
                ),
            )
        ),
    )
    portfolio = sgqlc.types.Field(
        "ModelPortfolio",
        graphql_name="portfolio",
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
        ...
        args=sgqlc.types.ArgDict(
            (
                (
                    "position_set",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(PositionSetInput),
                        graphql_name="positionSet",
                        default=None,
                    ),
                ),
                (
                    "base",
                    sgqlc.types.Arg(
                        sgqlc.types.list_of(PositionSetInput),
                        graphql_name="base",
                        default=None,
                    ),
                ),
    ...
    optimization = sgqlc.types.Field(
        "ModelOptimization",
        graphql_name="optimization",
        args=sgqlc.types.ArgDict(
            (
                (
                    "position_set",
                    sgqlc.types.Arg(
                        PositionSetInput, graphql_name="positionSet", default=None
                    ),
                ),
                (
                    "base",
                ...
                (
                    "on",
                    sgqlc.types.Arg(
                        sgqlc.types.list_of(Date), graphql_name="on", default=None
                    ),
                ),
                (
                    "objective",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(
                            sgqlc.types.list_of(OptimizationObjective)
                        ),
                        graphql_name="objective",
                        default=None,
                    ),
                ),
                (
                    "constraints",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(OptimizationConstraints),
                ...
                (
                    "securities",
                    sgqlc.types.Arg(
                        OptimizationSecuritiesInput,
                        graphql_name="securities",
                        default=None,
                    ),
                ),
                (
                    "constants",
                    sgqlc.types.Arg(
                        OptimizationConstantsInput,
                        graphql_name="constants",
                        default=None,
                    ),
                ),
                (
                    "options",
                    sgqlc.types.Arg(
                        OptimizationOptionsInput, graphql_name="options", default=None
                    ),
                ),
                (
                    "forecast",
                    sgqlc.types.Arg(
                        ForecastInput, graphql_name="forecast", default=None
                    ),
                ),
            )
        ),
            ...
            (
                (
                    ...
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(
                            sgqlc.types.list_of(
                                sgqlc.types.non_null(SecuritySearchFilter)
                            )
                        ),
                        graphql_name="filter",
                        default=None,
                ...
                (
                    "sort",
                    sgqlc.types.Arg(
                        sgqlc.types.list_of(SecuritySearchSort),
                        graphql_name="sort",
                        default=None,
                    ),
                ),
...
class ModelOptimization(sgqlc.types.Type):
    __schema__ = schema
    positions_delta = sgqlc.types.Field(
        sgqlc.types.list_of("OptimizationPositionsDelta"), graphql_name="positionsDelta"
    )
    risk = sgqlc.types.Field(sgqlc.types.list_of("Risk"), graphql_name="risk")
    risk_contributors = sgqlc.types.Field(
        sgqlc.types.list_of("RiskContributor"),
        graphql_name="riskContributors",
        args=sgqlc.types.ArgDict(
            (
                ...
                (
                    "equity_id_format",
                    sgqlc.types.Arg(
                        EquityIdFormat, graphql_name="equityIdFormat", default=None
                    ),
                ),
            )
        ),
    ...
    exposure = sgqlc.types.Field(
        sgqlc.types.list_of(Exposure),
        graphql_name="exposure",
        args=sgqlc.types.ArgDict(
            (
                (
                    "content_set_id",
                    sgqlc.types.Arg(String, graphql_name="contentSetId", default=None),
                ),
            )
        ),
    )
    exposure_contributors = sgqlc.types.Field(
        sgqlc.types.list_of(ExposureContributorDate),
        graphql_name="exposureContributors",
        args=sgqlc.types.ArgDict(
            (
                (
                    "content_set_id",
    ...
    performance = sgqlc.types.Field(
        sgqlc.types.list_of("Performance"),
        graphql_name="performance",
        args=sgqlc.types.ArgDict(
            (
                (
    ...
    positions = sgqlc.types.Field(
        "OptimizedPositionSet",
        graphql_name="positions",
        args=sgqlc.types.ArgDict(
            (("as_of", sgqlc.types.Arg(Date, graphql_name="asOf", default=None)),)
        ),
    )
    period_performance = sgqlc.types.Field(
        "PeriodPerformance",
        graphql_name="periodPerformance",
        args=sgqlc.types.ArgDict(
            (
                ("to", sgqlc.types.Arg(Date, graphql_name="to", default=None)),
                (
                    "risk_free_rate",
                    sgqlc.types.Arg(Float, graphql_name="riskFreeRate", default=None),
                ),
            )
        ),
    )
    correlation = sgqlc.types.Field(
        Float,
        graphql_name="correlation",
        args=sgqlc.types.ArgDict(
            (
                (
                    "to",
    ...
    composition = sgqlc.types.Field(
        sgqlc.types.list_of(Composition),
        graphql_name="composition",
        args=sgqlc.types.ArgDict(
            (
                (
                    "scale_format",
                    sgqlc.types.Arg(
                        ScaleFormat, graphql_name="scaleFormat", default=None
                    ),
                ),
                (
                    "equity_id_format",
    ...
    market_impact = sgqlc.types.Field(
        MarketImpact,
        graphql_name="marketImpact",
        args=sgqlc.types.ArgDict(
            (
                (
                    "equity_id_format",
...
class ModelPortfolio(sgqlc.types.Type):
    __schema__ = schema
    coverage = sgqlc.types.Field(
        sgqlc.types.list_of(Coverage),
        graphql_name="coverage",
        args=sgqlc.types.ArgDict(
            (
                (
                    "from_",
    ...
    performance_contributors = sgqlc.types.Field(
        sgqlc.types.list_of("PerformanceContributor"),
        graphql_name="performanceContributors",
        args=sgqlc.types.ArgDict(
            (
                (
                    "from_",
    ...
    grouped_performance_contributors = sgqlc.types.Field(
        sgqlc.types.list_of("PerformanceContributorGroup"),
        graphql_name="groupedPerformanceContributors",
        args=sgqlc.types.ArgDict(
            (
                (
                    "from_",
    ...
    grouped_risk_contributors = sgqlc.types.Field(
        sgqlc.types.list_of("RiskContributorGroup"),
    ...
    grouped_exposure_contributors = sgqlc.types.Field(
        sgqlc.types.list_of(GroupedExposureContributorDate),
        graphql_name="groupedExposureContributors",
        args=sgqlc.types.ArgDict(
            (
                (
                    "from_",
        ...
        args=sgqlc.types.ArgDict(
            (
                (
                    "position_set_delta",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(PositionSetDateInput),
                        graphql_name="positionSetDelta",
                        default=None,
                    ),
                ),
                (
...
class Mutation(sgqlc.types.Type):
    __schema__ = schema
    upload_daily_pnl = sgqlc.types.Field(
        "UploadDailyPnlResult",
        graphql_name="uploadDailyPnl",
        args=sgqlc.types.ArgDict(
            (
                (
                    "portfolio_id",
                ...
                (
                    "date",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(Date), graphql_name="date", default=None
                    ),
                ),
                (
                    "amount",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(Float), graphql_name="amount", default=None
                    ),
                ),
            )
        ),
    )
    delete_daily_pnl = sgqlc.types.Field(
        DeleteResult,
        graphql_name="deleteDailyPnl",
        args=sgqlc.types.ArgDict(
            (
                (
                    "portfolio_id",
                ...
                (
                    "dates",
                    sgqlc.types.Arg(
                        sgqlc.types.list_of(Date), graphql_name="dates", default=None
                    ),
                ),
                (
                    "all_dates",
                    sgqlc.types.Arg(Boolean, graphql_name="allDates", default=None),
                ),
            )
        ),
    )
    create_experiment = sgqlc.types.Field(
        Experiment,
        graphql_name="createExperiment",
        args=sgqlc.types.ArgDict(
            (
                (
                    "portfolio_id",
                ...
                (
                    "experiment",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(NewExperiment),
                        graphql_name="experiment",
                        default=None,
                    ),
                ),
            )
    ...
    update_experiment = sgqlc.types.Field(
        Experiment,
        graphql_name="updateExperiment",
        args=sgqlc.types.ArgDict(
            (
                (
                    "portfolio_id",
                ...
                (
                    "experiment",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(UpdateExperiment),
                        graphql_name="experiment",
                        default=None,
                    ),
                ),
    ...
    delete_experiment = sgqlc.types.Field(
        "SingleDeleteResult",
        graphql_name="deleteExperiment",
        args=sgqlc.types.ArgDict(
            (
                (
                    "portfolio_id",
    ...
    upload_experiment_date = sgqlc.types.Field(
        "UploadPositionSetResult",
        graphql_name="uploadExperimentDate",
        args=sgqlc.types.ArgDict(
            (
                (
                    "portfolio_id",
    ...
    delete_experiment_dates = sgqlc.types.Field(
        DeleteResult,
        graphql_name="deleteExperimentDates",
        args=sgqlc.types.ArgDict(
            (
                (
                    "portfolio_id",
    ...
    create_forecast = sgqlc.types.Field(
        ForecastMeta,
        graphql_name="createForecast",
        args=sgqlc.types.ArgDict(
            (
                (
                    "forecast",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(ForecastCreate),
                        graphql_name="forecast",
                        default=None,
                    ),
                ),
    ...
    update_forecast = sgqlc.types.Field(
        ForecastMeta,
        graphql_name="updateForecast",
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
                ...
                (
                    "update",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(ForecastUpdate),
                        graphql_name="update",
                        default=None,
                    ),
                ),
    ...
    delete_forecast = sgqlc.types.Field(
        "SingleDeleteResult",
        graphql_name="deleteForecast",
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
    ...
    upload_forecast_securities = sgqlc.types.Field(
        ForecastUpdateResult,
        graphql_name="uploadForecastSecurities",
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
                ...
                (
                    ...
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(
                            sgqlc.types.list_of(
                                sgqlc.types.non_null(ForecastSecurityInput)
                            )
                        ),
                        graphql_name="values",
                        default=None,
    ...
    delete_forecast_securities = sgqlc.types.Field(
        ForecastDeleteResult,
        graphql_name="deleteForecastSecurities",
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
                ...
                (
                    ...
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(
                            sgqlc.types.list_of(
                                sgqlc.types.non_null(DeleteForecastSecurityInput)
                            )
                        ),
                        graphql_name="values",
                        default=None,
    ...
    create_watchlist = sgqlc.types.Field(
        "WatchlistMeta",
        graphql_name="createWatchlist",
        args=sgqlc.types.ArgDict(
            (
                (
                    "name",
    ...
    delete_watchlist = sgqlc.types.Field(
        "SingleDeleteResult",
        graphql_name="deleteWatchlist",
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
    ...
    update_watchlist = sgqlc.types.Field(
        "WatchlistMeta",
        graphql_name="updateWatchlist",
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
                ...
                (
                    "update",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(WatchlistUpdate),
                        graphql_name="update",
                        default=None,
                    ),
                ),
    ...
    add_watchlist_securities = sgqlc.types.Field(
        "Watchlist",
        graphql_name="addWatchlistSecurities",
        args=sgqlc.types.ArgDict(
            (
                (
                    "watchlist_id",
                ...
                (
                    "securities",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(WatchlistSecuritiesInput),
                        graphql_name="securities",
                        default=None,
                    ),
                ),
    ...
    remove_watchlist_securities = sgqlc.types.Field(
        "Watchlist",
        graphql_name="removeWatchlistSecurities",
        args=sgqlc.types.ArgDict(
            (
                (
                    "watchlist_id",
    ...
    clear_watchlist_securities = sgqlc.types.Field(
        "Watchlist",
        graphql_name="clearWatchlistSecurities",
        args=sgqlc.types.ArgDict(
            (
                (
                    "watchlist_id",
    ...
    upload_pnl_date = sgqlc.types.Field(
        "UploadPnlResult",
        graphql_name="uploadPnlDate",
        args=sgqlc.types.ArgDict(
            (
                (
                    "portfolio_id",
                ...
                (
                    "data",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(PnlDateInput),
                        graphql_name="data",
                        default=None,
                    ),
                ),
    ...
    delete_pnl_dates = sgqlc.types.Field(
        DeleteResult,
        graphql_name="deletePnlDates",
        args=sgqlc.types.ArgDict(
            (
                (
                    "portfolio_id",
    ...
    update_portfolio = sgqlc.types.Field(
        "Portfolio",
        graphql_name="updatePortfolio",
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
                ...
                (
                    "portfolio",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(PortfolioUpdate),
                        graphql_name="portfolio",
                        default=None,
                    ),
                ),
    ...
    create_portfolio = sgqlc.types.Field(
        "Portfolio",
        graphql_name="createPortfolio",
        args=sgqlc.types.ArgDict(
            (
                (
                    "portfolio",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(NewPortfolio),
                        graphql_name="portfolio",
                        default=None,
                    ),
                ),
    ...
    delete_portfolio = sgqlc.types.Field(
        "SingleDeleteResult",
        graphql_name="deletePortfolio",
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
    ...
    upload_position_set_date = sgqlc.types.Field(
        "UploadPositionSetResult",
        graphql_name="uploadPositionSetDate",
        args=sgqlc.types.ArgDict(
            (
                (
                    "portfolio_id",
    ...
    delete_position_set_dates = sgqlc.types.Field(
        DeleteResult,
        graphql_name="deletePositionSetDates",
        args=sgqlc.types.ArgDict(
            (
                (
                    "portfolio_id",
                ...
                (
                    "delete_related_pnl",
                    sgqlc.types.Arg(
                        Boolean, graphql_name="deleteRelatedPnl", default=None
                    ),
                ),
            )
        ),
    )
    create_swap = sgqlc.types.Field(
        "Swap",
        graphql_name="createSwap",
        args=sgqlc.types.ArgDict(
            (
                (
                    "swap",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(NewSwap), graphql_name="swap", default=None
                    ),
                ),
            )
        ),
    )
    update_swap = sgqlc.types.Field(
        "Swap",
        graphql_name="updateSwap",
        args=sgqlc.types.ArgDict(
            (
                (
                    "ticker",
                ...
                (
                    "swap",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(SwapUpdate),
                        graphql_name="swap",
                        default=None,
                    ),
                ),
    ...
    delete_swap = sgqlc.types.Field(
        "SingleDeleteResult",
        graphql_name="deleteSwap",
        args=sgqlc.types.ArgDict(
            (
                (
                    "ticker",
    ...
    upload_swap_date = sgqlc.types.Field(
        "UploadPositionSetResult",
        graphql_name="uploadSwapDate",
        args=sgqlc.types.ArgDict(
            (
                (
                    "ticker",
    ...
    delete_swap_dates = sgqlc.types.Field(
        DeleteResult,
        graphql_name="deleteSwapDates",
        args=sgqlc.types.ArgDict(
            (
                (
                    "ticker",
...
class OptimizationPositionsDelta(sgqlc.types.Type):
    ...
    date = sgqlc.types.Field(Date, graphql_name="date")
    equities = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetEquity"), graphql_name="equities"
    )
    swaps = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetOtherAsset"), graphql_name="swaps"
    )
...
class OptimizedPositionSet(sgqlc.types.Type):
    __schema__ = schema
    dates = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetDate"), graphql_name="dates"
    )
...
class Performance(sgqlc.types.Type):
    ...
    date = sgqlc.types.Field(Date, graphql_name="date")
    rolled_over_from = sgqlc.types.Field(Date, graphql_name="rolledOverFrom")
    percent_return_cumulative = sgqlc.types.Field(
        "PerformanceItem", graphql_name="percentReturnCumulative"
    )
...
class PerformanceAttribution(sgqlc.types.Type):
    ...
    factors = sgqlc.types.Field(
        sgqlc.types.list_of("PerformanceAttributionFactor"),
        graphql_name="factors",
        args=sgqlc.types.ArgDict(
            (
                (
...
class PerformanceContributor(sgqlc.types.Type):
    ...
    isin = sgqlc.types.Field(Isin, graphql_name="isin")
    cusip = sgqlc.types.Field(Cusip, graphql_name="cusip")
    average_percent_equity = sgqlc.types.Field(
        Float, graphql_name="averagePercentEquity"
    )
    total = sgqlc.types.Field(Float, graphql_name="total")
    attribution = sgqlc.types.Field(
        "PerformanceContributorAttribution", graphql_name="attribution"
    )


class PerformanceContributorAttribution(sgqlc.types.Type):
    __schema__ = schema
    summary = sgqlc.types.Field(
        "PerformanceContributorAttributionSummary", graphql_name="summary"
    )
    factors = sgqlc.types.Field(
        sgqlc.types.list_of("PerformanceContributorAttributionFactor"),
        graphql_name="factors",
    )
...
class PerformanceContributorGroup(sgqlc.types.Type):
    ...
    total = sgqlc.types.Field(Float, graphql_name="total")
    contributors = sgqlc.types.Field(
        sgqlc.types.list_of(PerformanceContributor), graphql_name="contributors"
    )
    attribution = sgqlc.types.Field(
        PerformanceContributorAttribution, graphql_name="attribution"
    )
...
class PeriodPerformance(sgqlc.types.Type):
    ...
    annualized_volatility = sgqlc.types.Field(
        Float, graphql_name="annualizedVolatility"
    )
...
class PnlDate(sgqlc.types.Type):
    ...
    date = sgqlc.types.Field(sgqlc.types.non_null(Date), graphql_name="date")
    equities = sgqlc.types.Field(
        sgqlc.types.list_of("PnlEquity"), graphql_name="equities"
    )
    currencies = sgqlc.types.Field(
        sgqlc.types.list_of("PnlOtherAsset"), graphql_name="currencies"
    )
    swaps = sgqlc.types.Field(
        sgqlc.types.list_of("PnlOtherAsset"), graphql_name="swaps"
    )
    fixed_income = sgqlc.types.Field(
        sgqlc.types.list_of("PnlFixedIncome"), graphql_name="fixedIncome"
    )
    commodities = sgqlc.types.Field(
        sgqlc.types.list_of("PnlOtherAsset"), graphql_name="commodities"
    )
    indices = sgqlc.types.Field(
        sgqlc.types.list_of("PnlOtherAsset"), graphql_name="indices"
    )
    other_assets = sgqlc.types.Field(
        sgqlc.types.list_of("PnlOtherAsset"), graphql_name="otherAssets"
    )
...
class Portfolio(sgqlc.types.Type):
    ...
    daily_pnl = sgqlc.types.Field(
        sgqlc.types.list_of(DailyPnlDate),
        graphql_name="dailyPnl",
        args=sgqlc.types.ArgDict(
            (
                (
                    "from_",
    ...
    per_security_pnl = sgqlc.types.Field(
        sgqlc.types.list_of(PnlDate),
        graphql_name="perSecurityPnl",
        args=sgqlc.types.ArgDict(
            (
                (
                    "from_",
    ...
    experiments = sgqlc.types.Field(
        sgqlc.types.list_of(ExperimentMetadata),
        graphql_name="experiments",
        args=sgqlc.types.ArgDict(
            (
                (
                    "type",
                    sgqlc.types.Arg(ExperimentType, graphql_name="type", default=None),
                ),
            )
        ),
    )
    experiment = sgqlc.types.Field(
        Experiment,
        graphql_name="experiment",
        args=sgqlc.types.ArgDict(
            (
...
class PositionSetDate(sgqlc.types.Type):
    ...
    currencies = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetOtherAsset"), graphql_name="currencies"
    )
    swaps = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetOtherAsset"), graphql_name="swaps"
    )
    fixed_income = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetFixedIncome"), graphql_name="fixedIncome"
    )
    commodities = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetOtherAsset"), graphql_name="commodities"
    )
    indices = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetOtherAsset"), graphql_name="indices"
    )
    other_assets = sgqlc.types.Field(
        sgqlc.types.list_of("PositionSetOtherAsset"), graphql_name="otherAssets"
    )
...
class Query(sgqlc.types.Type):
    __schema__ = schema
    content_sets = sgqlc.types.Field(
        sgqlc.types.list_of(ContentSetMetadata), graphql_name="contentSets"
    )
    content_set = sgqlc.types.Field(
        ContentSet,
        graphql_name="contentSet",
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
    ...
    forecasts = sgqlc.types.Field(
        sgqlc.types.list_of(ForecastMeta), graphql_name="forecasts"
    )
    forecast = sgqlc.types.Field(
        ForecastDetails,
        graphql_name="forecast",
    ...
    watchlists = sgqlc.types.Field(
        sgqlc.types.list_of("WatchlistMeta"), graphql_name="watchlists"
    )
    watchlist = sgqlc.types.Field(
        "Watchlist",
        graphql_name="watchlist",
        args=sgqlc.types.ArgDict(
            (
                (
                    "id",
    ...
    models = sgqlc.types.Field(
        sgqlc.types.list_of(ModelMetadata), graphql_name="models"
    )
    portfolios = sgqlc.types.Field(
        sgqlc.types.list_of(PortfolioMetadata), graphql_name="portfolios"
    )
    portfolio = sgqlc.types.Field(
        Portfolio,
        graphql_name="portfolio",
...
class RiskAttribution(sgqlc.types.Type):
    ...
    factors = sgqlc.types.Field(
        sgqlc.types.list_of("RiskAttributionFactor"),
        graphql_name="factors",
        args=sgqlc.types.ArgDict(
            (
                (
...
class RiskContributor(sgqlc.types.Type):
    ...
    total = sgqlc.types.Field(Float, graphql_name="total")
    attribution = sgqlc.types.Field(
        "RiskContributorAttribution", graphql_name="attribution"
    )
...
class RiskContributorAttribution(sgqlc.types.Type):
    __schema__ = schema
    summary = sgqlc.types.Field(
        "RiskContributorAttributionSummary", graphql_name="summary"
    )
    factors = sgqlc.types.Field(
        sgqlc.types.list_of("RiskContributorAttributionFactor"), graphql_name="factors"
    )
...
class RiskContributorGroup(sgqlc.types.Type):
    ...
    total_percent_equity = sgqlc.types.Field(Float, graphql_name="totalPercentEquity")
    contributors = sgqlc.types.Field(
        sgqlc.types.list_of(RiskContributor), graphql_name="contributors"
    )
    attribution = sgqlc.types.Field(
        RiskContributorAttribution, graphql_name="attribution"
    )
...
class Security(sgqlc.types.Type):
    __schema__ = schema
    descriptors = sgqlc.types.Field(
        "SecurityDescriptors",
        graphql_name="descriptors",
        args=sgqlc.types.ArgDict(
            (
                (
                    "on",
    ...
    availability = sgqlc.types.Field(
        "SecurityAvailability", graphql_name="availability"
    )
    performance = sgqlc.types.Field(
        sgqlc.types.list_of("SecurityPerformance"),
        graphql_name="performance",
        args=sgqlc.types.ArgDict(
            (
                (
    ...
    exposure = sgqlc.types.Field(
        sgqlc.types.list_of("SecurityExposure"),
        graphql_name="exposure",
        args=sgqlc.types.ArgDict(
            (
                (
    ...
    risk = sgqlc.types.Field(
        sgqlc.types.list_of("SecurityPredictedRisk"),
        graphql_name="risk",
        args=sgqlc.types.ArgDict(
            (
                (
...
class SecurityExposure(sgqlc.types.Type):
    ...
    date = sgqlc.types.Field(Date, graphql_name="date")
    factors = sgqlc.types.Field(
        sgqlc.types.list_of("SecurityExposureFactor"),
        graphql_name="factors",
        args=sgqlc.types.ArgDict(
            (
                (
...
class SecurityPerformance(sgqlc.types.Type):
    ...
    date = sgqlc.types.Field(Date, graphql_name="date")
    percent_price_change_cumulative = sgqlc.types.Field(
        "SecurityPerformanceItem", graphql_name="percentPriceChangeCumulative"
    )
...
class SecurityPerformanceAttribution(sgqlc.types.Type):
    __schema__ = schema
    summary = sgqlc.types.Field(
        "SecurityPerformanceAttributionSummary", graphql_name="summary"
    )
    factors = sgqlc.types.Field(
        sgqlc.types.list_of("SecurityPerformanceAttributionFactor"),
        graphql_name="factors",
        args=sgqlc.types.ArgDict(
            (
                (
...
class SecurityPerformanceItem(sgqlc.types.Type):
    ...
    total = sgqlc.types.Field(Float, graphql_name="total")
    attribution = sgqlc.types.Field(
        SecurityPerformanceAttribution, graphql_name="attribution"
    )
...
class SecurityRisk(sgqlc.types.Type):
    __schema__ = schema
    standard_deviation = sgqlc.types.Field(
        "SecurityRiskStandardDeviation", graphql_name="standardDeviation"
    )
    variance_decomposition = sgqlc.types.Field(
        "SecurityRiskVarianceDecomposition", graphql_name="varianceDecomposition"
    )
...
class SecurityRiskVarianceDecomposition(sgqlc.types.Type):
    __schema__ = schema
    summary = sgqlc.types.Field(
        "SecurityRiskVarianceDecompositionSummary", graphql_name="summary"
    )
...
class SecuritySearchResult(sgqlc.types.Type):
    __schema__ = schema
    securities = sgqlc.types.Field(
        sgqlc.types.list_of(SecurityResult), graphql_name="securities"
    )
    count = sgqlc.types.Field(Int, graphql_name="count")
    countries = sgqlc.types.Field(
        sgqlc.types.list_of(SearchResultFacet), graphql_name="countries"
    )
    currencies = sgqlc.types.Field(
        sgqlc.types.list_of(SearchResultFacet), graphql_name="currencies"
    )
    sectors = sgqlc.types.Field(
        sgqlc.types.list_of(SearchResultFacet), graphql_name="sectors"
    )
    ...
    coverage = sgqlc.types.Field(
        ...
        args=sgqlc.types.ArgDict(
            (
                (
                    "model_id",
                    sgqlc.types.Arg(String, graphql_name="modelId", default=None),
                ),
            )
        ),
    )
...
class Watchlist(sgqlc.types.Type):
    ...
    last_updated = sgqlc.types.Field(
        sgqlc.types.non_null(DateTime), graphql_name="lastUpdated"
    )
    equities = sgqlc.types.Field(
        sgqlc.types.list_of("WatchlistEquity"), graphql_name="equities"
    )
    currencies = sgqlc.types.Field(
        sgqlc.types.list_of("WatchlistOtherAsset"), graphql_name="currencies"
    )
    swaps = sgqlc.types.Field(
        sgqlc.types.list_of("WatchlistOtherAsset"), graphql_name="swaps"
    )
    fixed_income = sgqlc.types.Field(
        sgqlc.types.list_of("WatchlistFixedIncome"), graphql_name="fixedIncome"
    )
    commodities = sgqlc.types.Field(
        sgqlc.types.list_of("WatchlistOtherAsset"), graphql_name="commodities"
    )
    indices = sgqlc.types.Field(
        sgqlc.types.list_of("WatchlistOtherAsset"), graphql_name="indices"
    )
